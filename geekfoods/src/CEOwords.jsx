function CEOWords() {
  return (
    <>
      <div className="flex">
        <div className="mx-36 px-8 py-16">
          <div className="[column-fill:_balance] lg:columns-3 lg:gap-6 ">
            <div className="mb-8 sm:break-inside-avoid">
              <blockquote className="rounded-xl bg-gray-100 p-6 shadow-lg">
              ...
              <div className="mt-4 flex items-center gap-4">
                ...
                <div className="text-sm">
                  ...
                  <p className="mt-2">Head of CEO</p>
                </div>
              </div>
            </div>
            <div className="mb-8 sm:break-inside-avoid">
