...
function Languages() {
  ...
  return (
    <div className="flex bg-black h-screen items-center flex-col gap-16 pt-32">
      <h1 className="text-4xl font-bold text-white">Text Translation App</h1>
      ...
      <button
        ...
        className="btn btn-success text-white text-2xl font-semibold"
      >
        Translate Text
      </button>
    </div>
